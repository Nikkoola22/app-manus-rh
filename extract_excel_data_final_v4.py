...
for col_idx in range(len(header_leaves_df.columns)):
    ...
    # Handle cases where one of the headers is 'nan' or they are identical
    if header_row1_val == 'nan' and header_row2_val == 'nan':
        combined_leave_headers.append(f'Col_{col_idx}') # Use a generic name for completely empty columns
